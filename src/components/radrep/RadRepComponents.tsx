...
const moduleLabels: Record<DraftType, string> = {
  ...
  liverTransplantUltrasound: 'Liver-Transplant Ultrasound',
  kidneyTransplantUltrasound: 'Kidney-Transplant Ultrasound',
  livingDonorLiver: 'Living-Donor Liver Evaluation',
  tracheobronchomalacia: 'Tracheobronchomalacia CT',
  fibroticLungDisease: 'Fibrotic Lung Disease HRCT',
  pulmonaryHypertensionCtpa: 'Pulmonary Hypertension CTPA',
  copdCt: 'COPD CT',
  cysticLungDisease: 'Cystic Lung Disease HRCT',
  lungCancerScreening: 'Lung Cancer Screening CT',
  viralPneumoniaCt: 'Viral-Pneumonia Chest CT',
  brainTumorMri: 'Brain Tumor MRI',
  multipleSclerosisMri: 'Multiple Sclerosis MRI',
  traumaticBrainInjury: 'Traumatic Brain Injury CT',
  niRads: 'Head and Neck Surveillance (NI-RADS)',
  dementiaMri: 'Dementia MRI',
  coronaryCta: 'Coronary CT Angiography',
  taviPlanningCta: 'TAVI Planning CTA',
  cardiomyopathyMri: 'Cardiac MRI for Adult Cardiomyopathy',
  aaaPostprocedure: 'AAA Postprocedural Surveillance',
  aaaPreprocedure: 'AAA Preprocedural Evaluation',
  calciumScore: 'Coronary Artery Calcium Scoring',

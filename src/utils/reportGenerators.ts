...
export function generateReportingWorkflowReport(moduleType: ModuleType, values: WorkflowValues): ReportSections {
  ...
  switch (moduleType) {
    ...
    case 'ctColonography':
      return generateCtColonographyReport(schema, values);
    case 'enterography':
      return generateEnterographyReport(schema, values);
    case 'perianalFistulaMri':
      return generatePerianalFistulaMriReport(schema, values);
    case 'adrenalIncidentaloma':
      return generateAdrenalIncidentalomaReport(schema, values);
    case 'adnexalCystUltrasound':
    ...
    case 'placentaAccretaMri':
      return generatePlacentaAccretaMriReport(schema, values);
    case 'liverTransplantUltrasound':
      return generateLiverTransplantUltrasoundReport(schema, values);
    case 'kidneyTransplantUltrasound':
